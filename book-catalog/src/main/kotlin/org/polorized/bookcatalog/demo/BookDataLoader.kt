...
class BookDataLoader(private val bookRepository: BookRepository) {
    ...
    fun loadBookTestData() {
        ...
        val book1 = Book(isbn ="1234567891", author = "Clement", title = "Spring Test", price =  BigDecimal.valueOf(10.00))
        val book2 = Book(isbn ="1234567892", author = "Zena", title = "Cloud Native", price =  BigDecimal.valueOf(12.00))
